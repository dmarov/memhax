...
)
{
    ...
    // relative JMP 0xE9
    this->inj_instructions[this->inj_instructions_size] = (std::byte)0xE9;
    ...
    auto diff1 = (this->regular_pointer + this->inj_size) - (this->jmp_addr + this->inj_instructions_size + 1 + this->ptr_size) ;
